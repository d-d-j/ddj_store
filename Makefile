...
src/%.o: ./src/%.cpp
	...
	g++ -I"./libs/pantheios/include" -I"./libs/stlsoft/include" -O0 -g3 -pedantic -pedantic-errors -Wall -Wextra -Wno-deprecated -c -fmessage-length=0 -std=c++11 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
