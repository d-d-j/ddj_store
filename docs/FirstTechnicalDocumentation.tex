...
%	\subsection{Opis funkcjonalności}
	...
	\caption{Test wytrzymałości serwera}
		\includegraphics[width=0.5\textwidth]{img/TestMasterOptions.png}
	\end{figure}
	
		\subsubsection{Test wydajności umieszczania danych na karcie}
	Kolejna próba miała na celu sprawdzenie szybkości obsługiwania zapytań dodania rekordu do bazy danych. Przeprowadzono podobne testy jak w punkcie poprzednim, tym razem z podłączonym węzłem wysyłając zapytania POST. 
		\begin{figure}[ht!]
	\centering
	\caption{Test szybkości dodawania rekordów}
		\includegraphics[width=0.5\textwidth]{img/TestSimpleInserts.png}
	\end{figure}
