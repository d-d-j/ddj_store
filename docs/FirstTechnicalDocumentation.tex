...
\section{Node}
	...
	\subsection{Przepływ danych}
		...
		\begin{enumerate}
			...
			\item Store Controller przekazuje do swojego wątku odpowiedzialnego za zapytania zadanie do wykonania. Ten tworzy obiekt QueryRequest do Query Monitora, który
				wykonuje operację query i zwraca mu QueryResult
