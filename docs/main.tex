...
\section{Wymagania funkcjonalne}
    ...
    Baza danych będzie zwracała dane z zadanych okresów czasu oraz dla wyspecyfikowanych kwalifikatorów (tag, seria), a także pozwalała na agregację tych danych przy pomocy predefiniowanych funkcji.
...
\section{Harmonogram prac}
    ...
    Wyodrębniono następujące etapy projektu
        ...
        \subsubsection{Poprawa wydajności}
            Na tym etapie cała funkcjonalność powinna być już zaimplementowana. Dodane zostaną testy integracyjne, zbieranie informacji o stanie węzłów oraz właściwy load balancing. Celem tego etapu będzie głównie eliminacja błędów oraz poprawa wydajności systemu. Poprzez wykonanie testów wydajności powinny zostać przygotowane wskazówki konfiguracji systemu.
