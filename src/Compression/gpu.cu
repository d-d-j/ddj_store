...
#define FETCH_DATA5(level, data, id, off) __fetch(level, data, id, 0, off); __fetch(level, data, id, 1, off); __fetch(level, data, id, 2, off ); __fetch(level, data, id, 3, off); __fetch(level, data, id, 4, off);
...
__global__ void decompress_var (int bl, int *out)
{
...
inline __device__ void __fetch(int level, int *data, int id, int pos, int off) {
    // pos * level / 4 -> pozycja bloku gdzie zaczac
    data[pos] = tex1Dfetch(tex_compressed_data_in, off + (id * level) / 4 + pos);
}
...
__device__ void gpu_decompress2(int id, int offset, int *r_in, int *r_out, int *out)
{
    FETCH_DATA1(2, r_in, id, offset);
...
__device__ void gpu_decompress3(int id, int offset, int *r_in, int *r_out, int *out)
{
    FETCH_DATA2(3, r_in, id, offset);
...
__device__ void gpu_decompress4(int id, int offset, int *r_in, int *r_out, int *out)
{
    FETCH_DATA1(4, r_in, id, offset);
...
__device__ void gpu_decompress5(int id, int offset, int *r_in, int *r_out, int *out)
{
    FETCH_DATA2(5, r_in, id, offset);
...
__device__ void gpu_decompress6(int id, int offset, int *r_in, int *r_out, int *out)
{
    FETCH_DATA2(6, r_in, id, offset);
...
__device__ void gpu_decompress7(int id, int offset, int *r_in, int *r_out, int *out)
{
    FETCH_DATA3(7, r_in, id, offset);
...
__device__ void gpu_decompress8(int id, int offset, int *r_in, int *r_out, int *out)
{
    FETCH_DATA2(8, r_in, id, offset);
...
__device__ void gpu_decompress9(int id, int offset, int *r_in, int *r_out, int *out)
{
    FETCH_DATA3(9, r_in, id, offset);
...
__device__ void gpu_decompress10(int id, int offset, int *r_in, int *r_out, int *out)
{
    FETCH_DATA3(10, r_in, id, offset);
...
__device__ void gpu_decompress11(int id, int offset, int *r_in, int *r_out, int *out)
{
    FETCH_DATA4(11, r_in, id, offset);
...
__device__ void gpu_decompress12(int id, int offset, int *r_in, int *r_out, int *out)
{
    FETCH_DATA3(12, r_in, id, offset);
...
__device__ void gpu_decompress13(int id, int offset, int *r_in, int *r_out, int *out)
{
    FETCH_DATA4(13, r_in, id, offset);
...
__device__ void gpu_decompress14(int id, int offset, int *r_in, int *r_out, int *out)
{
    FETCH_DATA4(14, r_in, id, offset);
...
__device__ void gpu_decompress15(int id, int offset, int *r_in, int *r_out, int *out)
{
    FETCH_DATA5(15, r_in, id, offset);
...
__device__ void gpu_decompress16(int id, int offset, int *r_in, int *r_out, int *out)
{
    FETCH_DATA4(16, r_in, id, offset);
